...
- Crear respaldos con `pg_dump` antes de cualquier cambio estructural mayor.
- Trabajar siempre sobre una copia de la base, nunca directamente sobre producción.
